...
echo "============================================"
echo "  批量训练并上传 Expert-D ~ Expert-L"
echo "============================================"
...
starts=(200 401 601 801 1001 1201 1401 1601 1801)
ends=(400 600 800 1000 1200 1400 1600 1800 2000)
...
for idx in "${!letters[@]}"; do
  ...
  if [[ "$UPLOAD_AFTER_TRAIN" == "1" ]]; then
    ...
    COMMIT_MESSAGE="Upload Expert-${upper_letter} LoRA trained on shard ${start_index}-${end_index}" \
